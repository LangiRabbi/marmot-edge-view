...
export function AddWorkstationCard({ onClick }: AddWorkstationCardProps) {
  return (
    ...
    >
      <Plus className="h-12 w-12 text-primary bg-transparent border-none outline-none mb-4 smooth-transition opacity-70 group-hover:opacity-100 group-hover:glow-primary" />
